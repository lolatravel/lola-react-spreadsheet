...
export function createRows(): Row[] {
  return [
    {
      name: { value: 'Search and Book', disabled: false },
    ...
    },
    {
      ...
      children: [{
        name: { value: 'Budget remainder', disabled: true },
